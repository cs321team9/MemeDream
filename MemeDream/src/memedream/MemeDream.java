...
public class MemeDream {
    ...
    public static void main(String[] args) {
        ...
        try 
        {
            dog = new ImageIcon(ImageIO.read(new File("C:/Users/Willi/Pictures/Camera Roll/WIN_20170902_14_50_29_Pro.JPG")));
            pug = new ImageIcon(ImageIO.read(new File("C:/Users/Willi/Pictures/Camera Roll/Kennedy2.JPG")));
            egg = new ImageIcon(ImageIO.read(new File("C:/Users/Willi/Pictures/Camera Roll/Kennedy.JPG")));
        } 
        catch (IOException e) 
        {
